    ...
    <Layout pathname={false}>
      <Wrapper>
        ...
        <Text>
          ...
          <Typography align="left" paragraph color="secondary">
            Delivery times will vary but usually, it is 1-2 days for UK, 3-5
            days for Europe and 5-10 days for US and Canada. I always obtain
            proof of postage but if you would like to upgrade postage or make
            any changes to how your item is shipped please contact me and I will
            be happy to supply pricing for alternative methods.
          </Typography>
          <Typography align="left" paragraph color="secondary">
          ...
          <Typography align="left" paragraph color="secondary">
            ...
            receiving the item. Refund will be made once I receive the item
            unused to its original condition and in its original packaging. If
            you do not have the original packaging item should be packaged
            carefully to ensure safe arrival as it was shipped to you. I will
            refund the total amount of purchase.
          </Typography>
          <Typography align="left" paragraph color="secondary">
          ...
          <Typography align="left" paragraph color="secondary">
            Items cannot be refunded in the event of exceeding the 14 days
            return policy.
          </Typography>
        </Text>
      </Wrapper>
